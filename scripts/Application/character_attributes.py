...
class Works :
    ...
    prm = {
        ...
        eWorks.BadStudent                : WorksPrm( dispName="不良学生"         , factor="肉体", skills=["", "", "", "", "", ] ),
        eWorks.UniversityStudent         : WorksPrm( dispName="大学生"           , factor="精神", skills=["", "", "", "", "", ] ),
        eWorks.PartTimeWorker            : WorksPrm( dispName="フリーター"       , factor="肉体", skills=["", "", "", "", "", ] ),
        eWorks.Teacher                   : WorksPrm( dispName="教師"             , factor="精神", skills=["", "", "", "", "", ] ),
        eWorks.HousewifeOrHusband        : WorksPrm( dispName="主婦・主夫"       , factor="社会", skills=["", "", "", "", "", ] ),
        eWorks.UgnChildrenA              : WorksPrm( dispName="UGNチルドレンA"   , factor="肉体", skills=["", "", "", "", "", ] ),
        eWorks.UgnChildrenB              : WorksPrm( dispName="UGNチルドレンB"   , factor="感覚", skills=["", "", "", "", "", ] ),
        eWorks.UgnChildrenC              : WorksPrm( dispName="UGNチルドレンC"   , factor="精神", skills=["", "", "", "", "", ] ),
        eWorks.UgnAgentA                 : WorksPrm( dispName="UGNエージェントA" , factor="肉体", skills=["", "", "", "", "", ] ),
        eWorks.UgnAgentB                 : WorksPrm( dispName="UGNエージェントB" , factor="感覚", skills=["", "", "", "", "", ] ),
        eWorks.UgnAgentC                 : WorksPrm( dispName="UGNエージェントC" , factor="精神", skills=["", "", "", "", "", ] ),
        eWorks.UgnAgentD                 : WorksPrm( dispName="UGNエージェントD" , factor="社会", skills=["", "", "", "", "", ] ),
        eWorks.UgnBranchManagerA         : WorksPrm( dispName="UGN支部長A"       , factor="肉体", skills=["", "", "", "", "", ] ),
        eWorks.UgnBranchManagerB         : WorksPrm( dispName="UGN支部長B"       , factor="感覚", skills=["", "", "", "", "", ] ),
        eWorks.UgnBranchManagerC         : WorksPrm( dispName="UGN支部長C"       , factor="精神", skills=["", "", "", "", "", ] ),
        eWorks.UgnBranchDirectorD        : WorksPrm( dispName="UGN支部長D"       , factor="社会", skills=["", "", "", "", "", ] ),
        eWorks.Criminal                  : WorksPrm( dispName="刑事"             , factor="感覚", skills=["", "", "", "", "", ] ),
        eWorks.Discipline                : WorksPrm( dispName="鑑識"             , factor="精神", skills=["", "", "", "", "", ] ),
        eWorks.Lawyer                    : WorksPrm( dispName="弁護士"           , factor="社会", skills=["", "", "", "", "", ] ),
        eWorks.DefensiveMember           : WorksPrm( dispName="防衛隊員"         , factor="感覚", skills=["", "", "", "", "", ] ),
        eWorks.Mercenary                 : WorksPrm( dispName="傭兵"             , factor="肉体", skills=["", "", "", "", "", ] ),
        eWorks.Researcher                : WorksPrm( dispName="研究者"           , factor="精神", skills=["", "", "", "", "", ] ),
        eWorks.Professor                 : WorksPrm( dispName="教授"             , factor="社会", skills=["", "", "", "", "", ] ),
        eWorks.Nurse                     : WorksPrm( dispName="看護師"           , factor="肉体", skills=["", "", "", "", "", ] ),
        eWorks.Doctor                    : WorksPrm( dispName="医者"             , factor="社会", skills=["", "", "", "", "", ] ),
        eWorks.Politician                : WorksPrm( dispName="政治家"           , factor="社会", skills=["", "", "", "", "", ] ),
        eWorks.Businessman               : WorksPrm( dispName="ビジネスマン"     , factor="精神", skills=["", "", "", "", "", ] ),
        eWorks.Executive                 : WorksPrm( dispName="エグゼクティブ"   , factor="社会", skills=["", "", "", "", "", ] ),
        eWorks.BarBusiness               : WorksPrm( dispName="水商売"           , factor="精神", skills=["", "", "", "", "", ] ),
        eWorks.Shopkeeper                : WorksPrm( dispName="商店主"           , factor="社会", skills=["", "", "", "", "", ] ),
        eWorks.ReligiousPerson           : WorksPrm( dispName="宗教家"           , factor="社会", skills=["", "", "", "", "", ] ),
        eWorks.Detective                 : WorksPrm( dispName="探偵"             , factor="精神", skills=["", "", "", "", "", ] ),
        eWorks.Bodyguard                 : WorksPrm( dispName="ボディーガード"   , factor="肉体", skills=["", "", "", "", "", ] ),
        eWorks.Driver                    : WorksPrm( dispName="ドライバー"       , factor="肉体", skills=["", "", "", "", "", ] ),
        eWorks.Yakuza                    : WorksPrm( dispName="ヤクザ"           , factor="肉体", skills=["", "", "", "", "", ] ),
        eWorks.Mafia                     : WorksPrm( dispName="マフィア"         , factor="感覚", skills=["", "", "", "", "", ] ),
        eWorks.Thief                     : WorksPrm( dispName="泥棒"             , factor="感覚", skills=["", "", "", "", "", ] ),
        eWorks.EgoWetter                 : WorksPrm( dispName="ネゴシエーター"   , factor="社会", skills=["", "", "", "", "", ] ),
        eWorks.Assassin                  : WorksPrm( dispName="暗殺者"           , factor="感覚", skills=["", "", "", "", "", ] ),
        eWorks.FortuneTeller             : WorksPrm( dispName="占い師"           , factor="精神", skills=["", "", "", "", "", ] ),
        eWorks.Artist                    : WorksPrm( dispName="アーティスト"     , factor="精神", skills=["", "", "", "", "", ] ),
        eWorks.Singer                    : WorksPrm( dispName="歌手"             , factor="感覚", skills=["", "", "", "", "", ] ),
        eWorks.Actor                     : WorksPrm( dispName="俳優"             , factor="社会", skills=["", "", "", "", "", ] ),
        eWorks.Magician                  : WorksPrm( dispName="奇術師"           , factor="感覚", skills=["", "", "", "", "", ] ),
        eWorks.Athlete                   : WorksPrm( dispName="アスリート"       , factor="肉体", skills=["", "", "", "", "", ] ),
        eWorks.Fighter                   : WorksPrm( dispName="格闘家"           , factor="肉体", skills=["", "", "", "", "", ] ),
        eWorks.Reporter                  : WorksPrm( dispName="記者"             , factor="精神", skills=["", "", "", "", "", ] ),
        eWorks.Announcer                 : WorksPrm( dispName="アナウンサー"     , factor="社会", skills=["", "", "", "", "", ] ),
        eWorks.Programmer                : WorksPrm( dispName="プログラマー"     , factor="社会", skills=["", "", "", "", "", ] ),
        eWorks.Hacker                    : WorksPrm( dispName="ハッカー"         , factor="精神", skills=["", "", "", "", "", ] ),
        eWorks.JackOfAllTrades           : WorksPrm( dispName="何でも屋"         , factor="肉体", skills=["", "", "", "", "", ] ),
        eWorks.Informer                  : WorksPrm( dispName="情報屋"           , factor="社会", skills=["", "", "", "", "", ] ),
        eWorks.Operative                 : WorksPrm( dispName="工作員"           , factor="感覚", skills=["", "", "", "", "", ] ),
    }
